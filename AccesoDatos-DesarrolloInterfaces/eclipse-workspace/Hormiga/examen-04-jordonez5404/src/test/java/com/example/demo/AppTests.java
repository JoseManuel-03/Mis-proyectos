...
class AppTests {
	...
	@Test
	@Order(4)
	void testconsultarCicloExistoso() throws NoExisteException {
		Ciclo cicloConsultado = matriculasService.consultarCiclo("3753723");
		// assertEquals(ciclo.getCodigo(), cicloConsultado.getCodigo());
	}
