...
public class MatriculasServiceImpl implements MatriculasService {
	 ...
	 * //METODO BUENO, ESTA CONMENTADO, AL IGUAL QUE EN EL ALUMNO REPOSITORY,
	 * PROBLEMA CON EL CODIGO. List<Alumno> lista =
	 * alumnoRepository.findByCodigoBetween(codCiclo, fechaDesde, fechaHasta);
	 * 
