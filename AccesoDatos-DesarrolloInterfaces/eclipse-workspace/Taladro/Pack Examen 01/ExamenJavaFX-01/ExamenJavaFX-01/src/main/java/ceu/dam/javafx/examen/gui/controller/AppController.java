...
public class AppController {
	...
	public static final String FXML_INICIO = PATH_BASE + "inicio.fxml";
	public static final String FXML_NUEVAREPARACION = PATH_BASE + "nuevaReparacion.fxml";
	public static final String FXML_BUSCARREPARACION = PATH_BASE + "buscarReparacion.fxml";
