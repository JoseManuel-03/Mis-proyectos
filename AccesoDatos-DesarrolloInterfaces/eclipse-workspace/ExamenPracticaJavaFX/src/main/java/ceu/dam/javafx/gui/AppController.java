...
public class AppController {
	...
	public static final String FXML_COMBOBOX = PATH_BASE + "comboBox.fxml";
	public static final String FXML_DATEPICKER = PATH_BASE + "datePicker.fxml";
	public static final String FXML_COLORPICKER = PATH_BASE + "colorPicker.fxml";
	public static final String FXML_SLIDER = PATH_BASE + "slider.fxml";
