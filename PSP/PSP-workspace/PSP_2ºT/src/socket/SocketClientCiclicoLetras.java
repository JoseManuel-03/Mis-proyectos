...
public class SocketClientCiclicoLetras {
	...
	public SocketClientCiclicoLetras(String address, int port) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		SocketClientCiclicoLetras cliente;
		cliente = new SocketClientCiclicoLetras("localhost", 8081);
		String datoEnviar = "";
